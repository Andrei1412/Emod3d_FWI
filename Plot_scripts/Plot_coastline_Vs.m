...
% Srn = readtable('SOURCE_SRF.13s.txt');
...
% snap_file1='NewVM_20200207_4KM/vs3dfile_iter_10.s';
% snap_file2='NewVM_20200207_4KM/vp3dfile_iter_10.p';
% snap_file1='NewVM_20200207_4KM/NZVM_2020/vs3dfile_iter_9.s';
% snap_file2='NewVM_20200207_4KM/NZVM_2020/vp3dfile_iter_9.p';
...
% snap_file1=strcat(filepath,'vs3dfile_iter_5.s');
% snap_file2=strcat(filepath,'vp3dfile_iter_5.p');

filepath='/home/andrei/workspace/GMPlots/Marlborough_Events_4KM/NewVM_20200207_4KM/NZVM_2020/2nd_RUN/';
snap_file1=strcat(filepath,'vs3dfile_iter_1.s');
snap_file2=strcat(filepath,'vp3dfile_iter_1.p');
...
Vsmean_arr =[3.1605,  3.5596, 3.8090]; % mean Vs_initial_NZVM2020 at 4km, 12km, 20km
% ss = [15, 32, 16, 29, 14];
ss = 1:13;
% ss = 1:16;
% ss = 1:27;
...
LL = flip(LL,2);
% Vsc_mean=mean(LL(:));
Vsc_mean = Vsmean_arr(1);
% Vsc_mean = 3.3
disp(Vsc_mean)

% Vsc_min=Vsc_mean*0.8; Vsc_max=Vsc_mean*1.2;
Vsc_min=Vsc_mean*0.7; Vsc_max=Vsc_mean*1.3;
fig = figure;
...
set(get(C,'XLabel'),'String','Vs (km/s)','fontsize',14)
set(gca,'CLim',[Vsc_min Vsc_max])

% xlabel('Longitude ','fontsize',14)
% ylabel('Latitude','fontsize',14)
% text(173.0,-43.5,1000,strcat('m_{00} at z =',{' '},num2str((z0-1)*dx),' km'),'fontweight','bold','fontsize',14)
% text(173.0,-43.5,1000,strcat('m_{10} at z =',{' '},num2str((z0-1)*dx),' km'),'fontweight','bold','fontsize',14)
% text(173.0,-43.5,1000,strcat('m_{09} at z =',{' '},num2str((z0-1)*dx),' km'),'fontweight','bold','fontsize',14)
text(173.0,-43.5,1000,strcat('m_{12} at z =',{' '},num2str((z0-1)*dx),' km'),'fontweight','bold','fontsize',14)
% text(173.0,-43.5,1000,strcat('m_{15} at z =',{' '},num2str((z0-1)*dx),' km'),'fontweight','bold','fontsize',14)
% text(173.0,-43.5,1000,strcat('m_{true} at z =',{' '},num2str((z0-1)*dx),' km'),'fontweight','bold','fontsize',14)
...
% text(171.2,-40.9,'Source0','fontsize',14);
% text(174.7 ,-42.7,'D5','fontsize',14);
